...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rlab-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2450&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rlab-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rlab` can be installed with:

```
conda install r-rlab
```

It is possible to list all of the versions of `r-rlab` available on your platform with:
